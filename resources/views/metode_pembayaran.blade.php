...
@section('contents')
    <div class="container mx-auto">
        ...
        <a href="{{ route('metode_pembayaran.create') }}" class="bg-blue-500 text-white p-2 rounded">+ Tambah Metode
            Pembayaran</a>
                ...
                @foreach ($metodePembayaran as $metode)
                    <tr>
                        ...
                        <td class="border px-4 py-2">
                            <a href="{{ route('metode_pembayaran.edit', $metode->id_metode) }}"
                                class="text-blue-600">Edit</a>
                            <form action="{{ route('metode_pembayaran.destroy', $metode->id_metode) }}" method="POST"
