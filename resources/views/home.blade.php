        ...
        <section class="relative overflow-hidden w-full">
            <div class="px-4 sm:px-6 lg:px-8 py-12">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <!-- Left Content -->
                    <div data-aos="fade-right" class="mt-[20px]">
                        <div class="flex items-center space-x-2 mb-4">
                            <span class="text-gray-600 flex items-center">
                                <svg class="w-4 h-4 text-yellow-400 mr-1" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M10 15l-5.6 3 1.1-6.4L0 6.6l6.4-.5L10 0l3.6 5.6 6.4.5-4.5 5.9 1.1 6.4L10 15z" />
                                </svg>
                                4.7 Rating
                            </span>
                        </div>
                        ...
                        <h1 class="text-4xl md:text-[56px] font-semibold mb-4 leading-[72px]">
                            ...
                            <span class="text-[#038EFF]">Doa Ibu Rental</span>
                    ...
                    <img src="assets/img/dot.png" alt="Dotted Element" data-aos="fade-up" data-aos-duration="1000"
                        ...
                        style="position: absolute; top: 440px; left: 560px; z-index: 0; width: 49px; height: 28px;">
    ...
    <section class="py-16 bg-gray-50">
        ...
        <section class="py-36 relative bg-cover bg-center bg-no-repeat"
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white relative z-10">
                ...
                <a href="{{ route('car.list') }}"
                    class="inline-flex items-center bg-white-600 text-white px-6 py-3 rounded-lg text-lg font-semibold shadow-lg hover:bg-blue-200 transition-all">
                    Sewa Sekarang!
                </a>
            </div>
        </section>
